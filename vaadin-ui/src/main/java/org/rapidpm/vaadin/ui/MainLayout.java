...
import org.rapidpm.vaadin.demo.views.Accounts;
import org.rapidpm.vaadin.demo.views.Home;
import org.rapidpm.vaadin.demo.views.Payments;
import org.rapidpm.vaadin.demo.views.Statistics;
import org.rapidpm.vaadin.demo.views.personnel.Accountants;
import org.rapidpm.vaadin.demo.views.personnel.Managers;
import org.rapidpm.vaadin.ui.components.FlexBoxLayout;
import org.rapidpm.vaadin.ui.components.navigation.bar.AppBar;
import org.rapidpm.vaadin.ui.components.navigation.bar.TabBar;
import org.rapidpm.vaadin.ui.components.navigation.drawer.NaviDrawer;
import org.rapidpm.vaadin.ui.components.navigation.drawer.NaviItem;
import org.rapidpm.vaadin.ui.components.navigation.drawer.NaviMenu;
import org.rapidpm.vaadin.ui.util.LumoStyles;
import org.rapidpm.vaadin.ui.util.css.FlexDirection;
import org.rapidpm.vaadin.ui.util.css.Overflow;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

@HtmlImport("frontend://styles/shared-styles.html")
@Viewport("width=device-width, minimum-scale=1.0, initial-scale=1.0, user-scalable=yes")
@PWA(name = "Issuetracker", shortName = "Issuetracker", iconPath = "/images/logo-18.png", backgroundColor = "#233348", themeColor = "#233348")
public class MainLayout extends FlexBoxLayout implements RouterLayout, PageConfigurator, AfterNavigationObserver {
  ...
  private void setAppHeaderInner(Component... components) {
    if (appHeaderInner == null) {
      ...
      column
          .getElement()
          .insertChild( 0, appHeaderInner.getElement() );
    }
  ...
  private void setAppFooterInner(Component... components) {
    if (appFooterInner == null) {
      ...
      column
          ...
          .insertChild( column
                            .getElement()
                            .getChildCount(), appFooterInner.getElement() );
    }
  ...
  public void configurePage(InitialPageSettings settings) {
    ...
    settings.addFavIcon( "icon", "META-INF/resources/frontend/styles/favicons/favicon.ico", "256x256" );
  }
